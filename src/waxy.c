 ...
 * waxy                                  *
 *****************************************/
/* Compiled by WAXC (Version Dec 28 2020)*/
...
char* w_str_new(char* x){int l = strlen(x);char* str = (char*)malloc(l);strncpy(str,x,l);str[l] = 0;return str;}
...
int main(){
  ...
  w_map_t* m=0;
  (m=w_map_new(1));
  w_map_set((m),(int64_t)("xyz"),((int64_t)(123)));
  w_map_set((m),(int64_t)("abc"),((int64_t)(456)));
  puts(w_int2str(((int)w_map_get((m),(int64_t)("xyz")))).data);
  w_map_remove((m),(int64_t)("xyz"));
  puts(w_int2str(((int)w_map_get((m),(int64_t)("xyz")))).data);
  return 0;
}
/*=== User Code            END   ===*/
