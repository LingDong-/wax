...
const char* TEXT_std_import_wat = "(import \"console\"    \"log\"        (func $wax::js::console.log (param i32) (param i32)))\n"
"(import \"debug\"      \"logi32\"     (func $__logi32 (param i32)))\n";
...
"(func $wax::arr_new (result i32)\n"
"  (local $ptr i32)\n"
"  (local $data i32)\n"
"  (local.set $ptr (call $wax::malloc (i32.const 12)))\n"
"  (local.set $data (call $wax::calloc (i32.mul (global.get $wax::DEFAULT_CAPACITY) (i32.const 4))))\n"
"  (call $wax::_arr_set_data (local.get $ptr) (local.get $data))\n"
"  (call $wax::_arr_set_length (local.get $ptr) (i32.const 0))\n"
"  (call $wax::_arr_set_capacity (local.get $ptr) (global.get $wax::DEFAULT_CAPACITY))\n"
"  (local.get $ptr)\n"
")\n"
"\n"
